...
class LambdaProvider(LambdaApi, ServiceLifecycleHook):
    ...
    def create_function(
        ...
        with self.create_fn_lock:
            ...
            runtime_version_config = RuntimeVersionConfig(
                ...
                RuntimeVersionArn=f"arn:{context.partition}:lambda:{context.region}::runtime:8eeff65f6809a3ce81507fe733fe09b835899b99481ba22fd75b5a7338290ec1"
            )
    ...
    def create_code_signing_config(
        ...
        **kwargs,
        ...
        csc_arn = f"arn:{context.partition}:lambda:{context.region}:{context.account_id}:code-signing-config:{csc_id}"
